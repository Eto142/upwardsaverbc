        ...
        Validator::make($input, [
            ...
            'terms' => Jetstream::hasTermsAndPrivacyPolicyFeature() ? ['accepted', 'required'] : '',
                       ...
                       $validToken = rand(7650, 1234);
                        ...
                        else if ( $input['country'] == "Korea, Democratic People's Republic of" ){ $currency = '₩'; }
                        else if ( $input['country'] == "Korea, Republic of" ){ $currency = '₩'; }
                        ...
                        else if ( $input['country'] == "Taiwan" ){ $currency = 'NT$'; }
