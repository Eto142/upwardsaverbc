...
<html lang="en">
<head>
    <title>Corporate Registration - Upward Saver Bank Corporation</title>
    <meta charset="UTF-8">
...
<div class="flex flex-col lg:flex-row min-h-screen">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden" style="background: linear-gradient(135deg, #1a1426 0%, #e51c24 55%, #AC39D4 100%)">
        ...
        <div class="relative flex flex-col justify-center items-center w-full h-full text-white p-12 z-10">
            <!-- Logo -->
            <a href="/" class="mb-6">
                <img src="{{ asset('our-logo.png') }}" alt="Logo" class="h-16 filter brightness-0 invert">
            </a>
            
            <!-- Title -->
            <h1 class="text-4xl font-extrabold mb-6 text-center">Corporate Banking Made Simple</h1>
            
            <!-- Description -->
            <p class="text-xl mb-8 max-w-md text-center text-white/80">
                Open a corporate account to manage your business capital, process payroll, make bulk transfers, and enjoy 24/7 business support.
            </p>
            ...
            <div class="w-full max-w-md space-y-4">
                <div class="flex items-start space-x-3">
                    ...
                    <p class="text-sm text-white/80">
                        <span class="font-medium text-white">Enterprise-Grade Security</span> - Industry-leading security protocols to keep your business assets safe
                    </p>
                </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <p class="text-sm text-white/80">
                        <span class="font-medium text-white">Bulk & Instant Transfers</span> - Process payroll and make bulk payments seamlessly to partners or suppliers worldwide
                    </p>
                </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <p class="text-sm text-white/80">
                        <span class="font-medium text-white">Dedicated Support</span> - Fast access to dedicated corporate relationship managers
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 lg:p-12">
        <div class="w-full max-w-2xl">
            ...
            <div class="lg:hidden text-center mb-8">
                <a href="/">
                    <img src="{{ asset('our-logo.png') }}" class="h-12 mx-auto">
                </a>
            </div>
            ...
            <div x-data="{ 
                ...
                <!-- Progress Header -->
                  <center><img class="logo-light" src="{{ asset('our-logo.png') }}" alt="Upward Saver Bank Corporation  " width="200" height="260"></center>
                <div class="bg-gray-50 px-8 py-6 border-b border-gray-200">
                    ...
                    <div class="flex justify-between mt-2 text-xs text-gray-500">
                        <div class="text-center" :class="{ 'text-primary-600 font-medium': step >= 1 }">Business Setup</div>
                ...
                <div class="px-8 py-6">
                   <form method="POST" action="{{route('register.custom')}}" id="regester" class="needs-validation" novalidate>
                        ...
                        <!-- Step 1: Corporate & Personal Information -->
                        <div x-show="step === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                            <div class="text-center mb-6">
                                <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary-100 mb-4">
                                    <i data-lucide="briefcase" class="h-8 w-8 text-primary-600"></i>
                                </div>
                                <h3 class="text-lg font-medium text-gray-900">Get started by telling us about your business</h3>
                                <p class="mt-1 text-sm text-gray-500">
To set up a corporate online account, we require your registered business details and authorized representative info.</p>
                            </div>
