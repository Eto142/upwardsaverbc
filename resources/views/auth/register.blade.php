...
<head>
    <meta charset="utf-8" />
    <title>Upward Saver Bank Corporation | CREATE ACCOUNT</title>
                        ...
                        <div class="p-2">
                            <form method="POST" action="{{route('register')}}" id="regester" class="needs-validation" novalidate>
                                ...
                                <div class="mt-4 text-center">
                                    <p class="mb-0">By registering you agree to the Upward Saver Bank Corporation <a href="#" class="text-primary">Terms of Use</a></p>
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        ...
                        <p>©
                            ...
                            </script> Powered by <i class="bx bx-check-shield text-success"></i> by Upward Saver Bank Corporation</p>
                    </div>
                </div>
...
<div class="position-fixed top-0 end-0 p-2" style="z-index: 1005">
    <div id="ErrorToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            <img src="https://Upward Saver Bank Corporation.com/user/logo.png" alt="" class="me-2" height="18">
