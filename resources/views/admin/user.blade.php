...
<!-- Content wrapper start -->
									...
									@endif
										...
										<ul class="list-group">
											...
											<li class="list-group-item">
												...
												<li class="list-group-item">
												<span>Account Pin: </span>{{$userProfile->account_pin}}
											</li>
											...
											<li class="list-group-item">
											 ...
											 <li class="list-group-item">
												<span>Account Status: </span>@if($userProfile->user_block==="0")UnBlocked
													
												@elseif($userProfile->user_block==="1")Blocked
														@endif		
											</li> 
											<li class="list-group-item">
	...
	<div class="col-xxl-12">
								...
								<div class="card m-2">
									<div class="card-body">
										<!-- Modal XL -->
										<a href="{{route('user_block',$userProfile->id)}}" class="edit-contact-card btn btn-success" >
										<button type="button" class="btn btn-success" >
											Block
										</button>
										</a>
							<a href="{{route('iuser_block',$userProfile->id)}}" class="edit-contact-card btn btn-danger" >
							<button type="button" class="btn btn-danger" >
							UnBlock
						</button>
							</a>
							...
							<div class="col-xxl-12">
								...
								<div class="card m-2">
									<div class="card-body">
										<!-- Modal XL -->
										<button type="button" class="btn btn-success" data-bs-toggle="modal"
											data-bs-target="#exampleModalCenter99">
											Update Email
										</button>
										<!-- Modal -->
										<div class="modal fade" id="exampleModalCenter99" tabindex="-1"
											aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
											<div class="modal-dialog modal-dialog-centered">
												<div class="modal-content">
													<div class="modal-header">
														<h5 class="modal-title" id="exampleModalCenterTitle">
														Update {{$userProfile->first_name}} {{$userProfile->last_name}} Email
														</h5>
														<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
													</div>
										<form  action="{{route('update.email',$userProfile->id)}}" method="POST">
                                              @csrf
													<div class="modal-body">
													<label class="form-label"> Email</label>
													<input type="hidden" name="id" value="{{$userProfile->id}}"/>
													<input type="email" name="email" class="form-control" style="color:blue" placeholder="{{$userProfile->email}}" />
														...
														<table id="highlightRowColumn" class="table custom-table">
															...
															<tbody>
																...
																<tr>
																    	...
																    	<td> <img src="{{asset('uploads/kyc/'.$userProfile->driver_license)}}" width="30%">
																	</td>
