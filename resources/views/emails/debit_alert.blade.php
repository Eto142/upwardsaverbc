...
<p style="margin:0 0 24px;color:#6b7280;font-size:14px;line-height:1.6">A debit has been made from your account. Please find the details below.</p>

<!-- Amount highlight -->
<table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:22px">
  <tr>
    <td align="center" style="background:linear-gradient(135deg,#a51c24,#e51c24);border-radius:12px;padding:22px 20px">
      <p style="margin:0 0 4px;color:rgba(255,255,255,0.75);font-size:11px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;text-align:center">Amount Debited</p>
