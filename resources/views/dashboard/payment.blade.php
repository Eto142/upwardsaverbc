...
<div class="main-content">
   ...
   <div class="alert alert-success mb-2">{{session('message')}}</div>
                    ...
                    <div class='mt-4'>
                        ...
                        <div>
                            <div class="mt-2 mb-4">
                             ...
                             <p style="color: black"> Send {{$amount}} worth {{$item}} to the wallet address below or scan the qr code with your wallet app</p> 
    ...
    <!---------Card ENDs Here------------->
            ...
            <center>
            <!--<form action="{{url('/make-cryptodeposit')}}" method="POST" enctype="multipart/form-data">-->
            <!--@csrf													-->
            <!--<div class='col-sm-6'>-->
            <!--        <div class='mt-4'>-->
            <!--            <div>-->
            <!--                <label for='formFileLg' class='form-label'>Upload Proof</label>-->
                            <!--<input class='form-control form-control-lg accept='image' name='image' type='file'>-->
            <!--                 <input type="hidden" name="amount" value="{{$amount}}">-->
            <!--                   <input type="hidden" name="deposit_type" value="{{$item}}">-->
            <!--            </div>-->
            <!--        </div>-->
            <!--    </div>-->
            <!--    <button type='submit' class='btn btn-primary btn-sm btn-rounded shadow' -->
            <!--    > <ion-icon class='fa fa-camera'> Confirm Payment </ion-icon></button>-->
            <!--</form>-->
