        ...
        ***********************************-->
        ...
        @endif
            <div class="container-fluid">
                <h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Crypto Deposit</h2>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card">
                                    <div class="card-body">
                                        <p>You're about to deposit into your account balance.</p>
                                        ...
                                        <form action="{{url('get-deposit')}}" method="POST">
                                            ...
                                            <div id="content-one">
                                                ...
                                                <!--    <input id="pin_account_number" type="number" placeholder="Enter Transaction Pin" name="transaction_pin" maxlength="4" class="form-control" Required>-->
                                                <!--</div>-->
                                                

                                                <button type="submit" id="waitone" class="btn btn-primary w-100" >Proceed to Payment</button>
                                            </div> 
                                        </form>
