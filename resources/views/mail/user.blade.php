    ...
    <div class="container">
        ...
        <div class="content">
         <h2>{{ $data['subject'] }}</h2>
            ...
            <!--<p>If you have any questions or concerns, please don't hesitate to contact our support team at <a href="mailto:support@Upward Saver Bank Corporation.cc">support@Upward Saver Bank Corporation.cc</a>.</p>-->
