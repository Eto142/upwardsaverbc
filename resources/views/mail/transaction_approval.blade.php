...
@section('title', 'Transaction Successful — Upward Saver Bank Corporation')
...
<table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:22px">
  <tr>
    <td align="center">
      <span style="display:inline-block;background:#dcfce7;color:#15803d;border:1px solid #bbf7d0;border-radius:50px;padding:5px 16px;font-size:12px;font-weight:700;letter-spacing:.5px">✅ &nbsp;SUCCESSFUL</span>
    </td>
  </tr>
</table>
