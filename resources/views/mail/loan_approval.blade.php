...
@section('title', 'Loan Application Approved — Upward Saver Bank Corporation')
@section('badge', 'Loan Update')
@section('icon', '💰')
@section('header_title', 'Loan Application Approved')
  ...
  <tr>
    <td style="background:#f9fafb;border-left:4px solid #e51c24;border-radius:0 8px 8px 0;padding:14px 18px">
      <p style="margin:0;color:#6b7280;font-size:13px;line-height:1.7">
        If you have any questions about your loan, please contact our support team.
      </p>
    </td>
  </tr>
</table>
